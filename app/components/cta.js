  ...
  return (
    <section id="cta" className="bg-gray-900 py-16 text-center">
      <div className="container mx-auto px-4">
        ...
        <a href="#contact" className="inline-block bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 md:py-4 md:px-10 rounded-full shadow-lg transition duration-300 ease-in-out">Reach Me</a>
      </div>
    </section>
  );
};
